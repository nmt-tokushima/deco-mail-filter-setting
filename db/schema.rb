...
ActiveRecord::Schema.define(version: 2018_07_17_085652) do

  create_table "api_access_allowed_ips", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
